...
describe('Тестування API без змін у коді', () => {
    ...
    beforeAll(() => {
        ...
        testApp.post('/login', (req, res) => {
            ...
            // Вдалий логін користувача `Alex1973`
            if (username === 'Alex1973' && password === 'Alex1973!') {
    ...
    test('Перевірка вдалого входу користувача `Alex1973`', async () => {
        const response = await request(testApp)
            .post('/login')
            .send({ username: 'Alex1973', password: 'Alex1973!' });
